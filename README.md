...
![resume-template]("Gatsby resume template")
...
gatsby new my-resume https://github.com/jayshidhp/gatsby-resume
```
...
backend:
  name: github
  repo: jayshidhp/gatsby-resume #TODO replace this with your own repo
```
...
I hope you enjoy the resume template, if you do please follow me on [twitter](https://twitter.com/jayshidh) and send me your results.
